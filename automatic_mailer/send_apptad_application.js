/**
 * DISPATCH APPTAD RECRUITER APPLICATION - HYDERABAD (KOKAPET)
 * Target: Shalima@apptad.com (Shalima Singh)
 */
...
async function sendApptad() {
  const email = "Shalima@apptad.com";
  const history = loadHistory();
...
My name is Murali Krishna Popuri, and I am writing to apply for the Full Stack Developer opening at Apptad in Hyderabad (Kokapet).
...
I am an immediate joiner (official Last Working Day of Nov 11, negotiable for immediate release upon offer). I am currently located in Vijayawada and available to relocate immediately to Hyderabad for hybrid/onsite work in Kokapet.
...
<body>
  ...
  <p>My name is Murali Krishna Popuri, and I am writing to apply for the <strong>Full Stack Developer</strong> opening at Apptad in Hyderabad (Kokapet).</p>
  ...
  <p>I am an <strong>immediate joiner</strong> (official Last Working Day of Nov 11, negotiable for immediate release upon offer). I am currently located in Vijayawada and available to relocate <strong>immediately</strong> to Hyderabad for hybrid/onsite work in Kokapet.</p>
  ...
  recordSent(email, "Apptad", "Full Stack Developer", info.messageId);
}

sendApptad().catch((err) => {
  console.error("Error sending to Apptad:", err);
  process.exit(1);
});
