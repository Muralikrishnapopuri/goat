...
/**
 * ============================================================
 *  🚀 Automated Job Outreach Mailer — Zenbyt Private Limited
 * ============================================================
 * Target: info@zenbyt.com
 * Company: Zenbyt Private Limited
...
async function main() {
  console.log("============================================================");
  console.log("  Zenbyt Private Limited — Automated Application Mailer");
  console.log("============================================================");
  ...
  console.log(`\nDispatching live email to: ${TARGET.email}...`);
  ...
  recordHistory(TARGET.email, "SENT", info.messageId);
}
