...
/**
 * ============================================================
 *  🚀 Automated Job Outreach Mailer — Enterpi Software Solutions
 * ============================================================
 * Target: contact@enterpi.com
...
async function main() {
  ...
  console.log("============================================================");
  console.log("  Enterpi Software Solutions — Automated Application Mailer");
  console.log("============================================================");
  ...
  if (!isSend && !isTest) {
    ...
    console.log("    node send_enterpi_application.js --send");
    console.log("============================================================");
    return;
  }
