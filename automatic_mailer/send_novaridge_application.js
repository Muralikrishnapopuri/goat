...
/**
 * ============================================================
 *  🚀 Automated Job Outreach Mailer — Novaridge Civil Services
 * ============================================================
 * Target: info@novaridgecivilservices.com.au
 * Company: Novaridge Civil Services
...
const TARGET = {
  company: "Novaridge Civil Services",
  email: "info@novaridgecivilservices.com.au",
  role: "Full Stack Developer",
};
...
I'm reaching out to apply for the ${TARGET.role} position at ${TARGET.company}.
...
I am currently based in Vijayawada, Andhra Pradesh, and available for remote, hybrid, or relocation opportunities. I am serving my notice period with an official Last Working Day of Nov 11, but my manager is flexible and I can be released earlier to join immediately upon offer.
...
<body>
  ...
  <p>I'm reaching out to apply for the ${TARGET.role} position at ${TARGET.company}.</p>
  ...
  I am currently based in Vijayawada, Andhra Pradesh, and available for remote, hybrid, or relocation opportunities. I am serving my notice period with an official Last Working Day of Nov 11, but my manager is flexible and I can be released earlier to join immediately upon offer.</p>
...
async function main() {
  ...
  console.log("============================================================");
  console.log("  Novaridge Civil Services — Automated Application Mailer");
  console.log("============================================================");
  ...
  if (!isSend && !isTest) {
    ...
    console.log("    node send_novaridge_application.js --send");
    console.log("  To send a test email to your own inbox, run:");
    console.log("    node send_novaridge_application.js --test");
    console.log("============================================================");
    return;
  }
