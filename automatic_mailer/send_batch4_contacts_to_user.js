/**
 * SEND BATCH 4 CONTACTS & READY-TO-COPY MESSAGES TO USER
...
const contacts = [
  {
    ...
    notes: "Walk-in drive & email outreach. Mobile provided in post.",
    message: `Hi Siddharth,

I saw your post regarding the React JS + TypeScript Developer walk-in drive in Hyderabad.

I am a Full-Stack Developer with 2 years of professional experience specializing in React.js, TypeScript, JavaScript (ES6+), and REST APIs. At YoungMinds, I build RestoSoft—an offline-first POS desktop platform with local LAN real-time synchronization.
...
+91 9347796811`,
  },
  {
    ...
    role: "Full Stack Developer (Java / React / SQL) | Hyderabad",
    phone: "+91 733-8787597",
    email: "WhatsApp CV submission requested",
    notes: "WhatsApp CV submission requested in post (+91 733-8787597).",
    message: `Hi Kobika,
...
I am a Full-Stack Developer with 2 years of experience building responsive web platforms with React.js, TypeScript, Redux, and REST APIs. At YoungMinds, I build RestoSoft—an offline-first POS desktop system with local LAN real-time synchronization.
...
async function sendSummary() {
  ...
  let plain = "MURALI KRISHNA POPURI - RECRUITER CONTACTS & READY-TO-COPY WHATSAPP/SMS MESSAGES (BATCH 4)\n";
  plain += "========================================================================================\n\n";
  ...
  let html = `<div style="font-family: Arial, sans-serif; max-width: 750px; margin: 0 auto; color: #222222; line-height: 1.5;">
    <h2 style="color: #0b57d0; border-bottom: 2px solid #e1e4e8; padding-bottom: 8px;">Recruiter Mobile Contacts & Ready-to-Copy Messages (Batch 4)</h2>
    <p style="font-size: 14px; color: #555;">Here are the verified recruiter contacts extracted from your latest LinkedIn feed search ("React" AND "Hyderabad"). Each has a phone/WhatsApp number and a short, tailored message ready for you to copy and send via WhatsApp/SMS.</p>`;
  ...
  const mailOptions = {
    ...
    to: TARGET_EMAIL,
    subject: `Recruiter Phone Contacts & Ready-to-Copy WhatsApp Messages (${contacts.length} Contacts) - Murali Krishna`,
    text: plain,
    html: html,
  };
