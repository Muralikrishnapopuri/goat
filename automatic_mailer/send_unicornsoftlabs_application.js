...
/**
 * ============================================================
 *  🚀 Automated Job Outreach Mailer — Unicorn Soft Labs
 * ============================================================
 * Target: info@unicornsoftlabs.com
 * Company: Unicorn Soft Labs
...
const TARGET = {
  company: "Unicorn Soft Labs",
  email: "info@unicornsoftlabs.com",
  role: "Full Stack Developer",
  location: "Hyderabad",
};
...
async function main() {
  ...
  console.log("============================================================");
  console.log("  Unicorn Soft Labs — Automated Application Mailer");
  console.log("============================================================");
  ...
  if (!isSend && !isTest) {
    ...
    console.log("    node send_unicornsoftlabs_application.js --send");
    console.log("============================================================");
    return;
  }
